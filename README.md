...
- 可删除未使用的内置主题或“我的”已保存主题；当前活动主题和默认恢复主题 `paper-light` 受到保护，删除时背景媒体进入 Windows 回收站。
...
- “已存主题设置”可在主程序内直接编辑“我的”主题的显示与取景参数；编辑当前活动主题后实时刷新，无需重启 Codex。
- 暂停或继续皮肤显示。
...
| 删除主题 | 删除未使用的内置主题或“我的”主题，背景媒体进入 Windows 回收站；活动主题和默认恢复主题不可删除 |
